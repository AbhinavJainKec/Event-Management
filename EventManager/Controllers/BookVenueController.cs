...
{
    [ValidateUserSession]
    public class BookVenueController : Controller
    {
        private IBookVenue _IBookVenue;
        private IVenue _IVenue;
        public BookVenueController(IBookVenue IBookVenue, IVenue IVenue)
        {
        ...
        {
            bool result = _IBookVenue.checkBookingAvailability(objBV);
            if (result == false)
            {
        ...
        public IActionResult BookVenue(BookingVenue BookingVenue)
        {
            if (ModelState.IsValid)
            {
                ...
                var result = _IBookVenue.BookEvent(BD);
                ...
                var VenueID = _IBookVenue.BookVenue(BV);
        ...
        public JsonResult ShowBookingDetails()
        {
            ...
            {
                var result = _IBookVenue.ShowBookingDetail(Convert.ToInt32(HttpContext.Session.GetString("UserID")));
